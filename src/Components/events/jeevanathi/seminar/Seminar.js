...
const SeminarData=[{
    ...
    description: 'அது பற்றிய சிறிய விளக்கம்... அது பற்றிய சிறிய விளக்கம்... அது பற்றிய சிறிய விளக்கம்... அது பற்றிய சிறிய விளக்கம்... அது பற்றிய சிறிய விளக்கம்',
    time:'காலை 9:00',
    date:'22.03.2024',
    speaker:{
        name:'X',
    ...
    youtubeLink:'https://www.youtube.com/watch?v=pwnnY_qR1EU&t=524s&ab_channel=TLAUOM'
...
function Seminar() {
  return (
    <div>
      <Container maxWidth="lg" className="seminar-container" sx={{ pb: 4 }}>
